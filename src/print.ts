...
function getScriptsAndStyles(uri: vscode.Uri) {
    ...
    const copyTeXJs = '<script src="https://cdn.jsdelivr.net/npm/katex-copytex@latest/dist/katex-copytex.min.js"></script>';
