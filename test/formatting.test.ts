...
suite("Formatting.", () => {
    ...
    test("Toggle italic. Use `_`", done => {
        testCommand('markdown.extension.editing.toggleItalic', ['text'], new Selection(0, 0, 0, 4), ['_text_'], new Selection(0, 0, 0, 6), { 'markdown.extension.italic.indicator': '_' }).then(done, done);
    });
